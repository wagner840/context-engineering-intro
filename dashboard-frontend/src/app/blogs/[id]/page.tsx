...
export default function BlogDetailPage() {
  ...
  const [wpConnectionStatus, setWpConnectionStatus] = useState<
  ...
  const getWordPressStats = useCallback(async (wpUrl: string) => {
    try {
  ...
  const testWordPressConnection = useCallback(
    async (blogData: Blog) => {
      try {
    ...
    try {
      ...
      for (const wpPost of wpPosts) {
        const postData = {
          ...
          word_count: wpPost.content.rendered.replace(/<[^>]*>/g, "").split(" ")
            .length,
          reading_time: Math.ceil(
            wpPost.content.rendered.replace(/<[^>]*>/g, "").split(" ").length /
              200
          ),
        };
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Badge
              variant={
                wpConnectionStatus === "connected" ? "default" : "destructive"
              }
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-1">
                      {blog.niche || "Não definido"}
                    </p>
                  </div>
                  <div>
                    <Label>URL WordPress</Label>
                    <p className="text-sm mt-1">
                      {settings?.wordpress_url || "Não configurado"}
                    </p>
                  </div>
                </div>
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <div className="flex items-center space-x-4 mt-2 text-sm text-muted-foreground">
                            ...
                            <span>
                              Competição: {keyword.competition || "N/A"}
                            </span>
                          </div>
                        </div>
                        <div className="flex items-center space-x-2">
