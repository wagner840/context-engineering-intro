...
export default function ContentEditorPage() {
  ...
  const runSeoAnalysis = () => {
    ...
    if (editorData.metaDescription.length > 0) {
      if (editorData.metaDescription.length >= 120 && editorData.metaDescription.length <= 160) {
        analysis.meta.score = 100
      } else {
        analysis.meta.score = 60
        analysis.meta.issues.push('Meta description deve ter entre 120-160 caracteres')
      }
    } else {
    ...
    if (wordCount > 300) {
      ...
      if (wordCount < 1000) {
        analysis.content.issues.push('Conteúdo pode ser mais detalhado (recomendado: 1000+ palavras)')
      }
    } else {
      analysis.content.score = 40
      analysis.content.issues.push('Conteúdo muito curto (mínimo: 300 palavras)')
    }
    ...
    totalScore = Math.round(
      (analysis.title.score + analysis.meta.score + analysis.content.score + 
       analysis.keywords.score + analysis.readability.score) / 5
    )
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600">Crie e edite conteúdo otimizado para SEO</p>
            </div>
          </div>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setEditorData(prev => ({ ...prev, metaTitle: e.target.value }))}
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => setEditorData(prev => ({ ...prev, metaDescription: e.target.value }))}
                  placeholder="Descrição para mecanismos de busca..."
                  rows={3}
                />
                <div className="text-xs text-gray-500">
                  {editorData.metaDescription.length}/160 caracteres recomendados
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) => setEditorData(prev => ({ ...prev, blog: e.target.value }))}
                  className="w-full p-2 border border-gray-300 rounded-md"
                >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`text-sm ${getSeoScoreColor(seoAnalysis.title.score)}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`text-sm ${getSeoScoreColor(seoAnalysis.meta.score)}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`text-sm ${getSeoScoreColor(seoAnalysis.content.score)}`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`text-sm ${getSeoScoreColor(seoAnalysis.keywords.score)}`}>
